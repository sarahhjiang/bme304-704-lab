...
$$z=\beta_0+\beta_1X,\qquad \sigma(z)=\frac{1}{1+e^{-z}},\qquad p(X)=\sigma(z)=\frac{1}{1+e^{-(\beta_0+\beta_1X)}}=\frac{e^{\beta_0+\beta_1X}}{1+e^{\beta_0+\beta_1X}} \quad \Longleftrightarrow \quad \log\left(\frac{p(X)}{1-p(X)}\right)=\beta_0+\beta_1X$$
